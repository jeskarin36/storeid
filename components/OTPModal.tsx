  ...
  <AlertDialogContent className='shad-alert-dialog'>
    <AlertDialogHeader className='relative flex justify-center'> 
      <AlertDialogTitle className='h2 text-center'>Enter your OTP
        <img src="/assets/icons/close-dark.svg" alt="" width={20} height={20}  onClick={()=>setIsOpen(false)}  className='otp-close-button' />
      </AlertDialogTitle>
  ...
  <InputOTPGroup className='shad-otp'>
    ...
    <AlertDialogFooter>
        <div className="flex w-full flex-col gap-4"> 
            <AlertDialogAction onClick={handleSubmit} className='shad-submit-btn h-12' type='button'>Submit {isLoading && <img src="/assets/icons/loader.svg" alt="" width={24} height={24} className='ml-2 animate-spin' />} </AlertDialogAction>
